...
`/home/youzhi/ArgonneAI` (main clone stays on `argonne4.0`: other work is running).
...
| whole run | 62.1B tokens / 11.8 calendar days | 61,030 | n/a |
...
| Micro-batch | 170/GPU, accum 1 | n/a | **probe it** (start 16/GPU × 2048) | Finding C is retracted: measure on a pinned card, don't assume |
